...
=\exp(\sum_{i=1}^{M-1}x_k\log \mu_k+(1-\sum_{i=1}^{M-1}x_k)\log(1-\sum_{i=1}^{M-1}\mu_k))\\
=(1-\sum_{i=1}^{M-1}\mu_k)\exp(\sum_{i=1}^{M-1}x_k\log(\frac{\mu_k}{1-\sum_{i=1}^{M-1}\mu_k}))\\
=(1-\sum_{i=1}^{M-1}\mu_k)\exp(\sum_{i=1}^{M}x_i)
$$
